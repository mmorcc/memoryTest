package com.org.myapplication.net;
...
//    Call<Data> sendMAC(@HeaderMap Map<String, String> headers, @Body RequestBody body);
    ...
    @POST("minicall/getAllCallTypes")
    Call<Data<CallingTypeBean>> getAllCallTypes(@Query("pageNum")  int pageNum, @Query("pageSize") int pageSize);

    @POST("minicall/getDeviceById")
    Call<Data<MyDevice>> getDeviceById(@Query("deviceId")  String deviceId);

    @POST("minicall/updateCalling")
    Call<Data<MyBoolean>> updateCalling(@Body RequestBody user);
    @POST("minicall/updateDevice")
    Call<Data<MyBoolean>> updateDevice(@Body RequestBody user);
