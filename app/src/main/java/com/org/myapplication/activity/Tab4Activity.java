...
public class Tab4Activity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.right_btn).setOnClickListener(view -> {
            ...
            Util.type.setcTimes(Util.type.cTimes+1);
            Intent intent=new Intent(Tab4Activity.this,ShopCarActivity.class);
...
//                Util.uSelect.clear();
//                Intent intent=new Intent(Tab4Activity.this, SelectActivity.class);
...
//                Util.startTime=new Date().getTime();
//                Util.uSelect.clear();
//                Intent intent=new Intent(Tab4Activity.this, Tab4Activity.class);
//                intent.putExtra("title","请选择");
//                intent.putExtra("subType",0);
//            }
