...
public class Tab8Activity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.right_btn).setOnClickListener(view -> {
            ...
            Util.type.setcTimes(Util.type.cTimes+1);
            Intent intent=new Intent(Tab8Activity.this,ShopCarActivity.class);
...
//                Util.uSelect.clear();
//                Intent intent=new Intent(Tab8Activity.this, SelectActivity.class);
...
//                Util.startTime=new Date().getTime();
//                Util.uSelect.clear();
//                Intent intent=new Intent(Tab8Activity.this, Tab8Activity.class);
//                intent.putExtra("title","请选择");
//                intent.putExtra("subType",0);
//            }
